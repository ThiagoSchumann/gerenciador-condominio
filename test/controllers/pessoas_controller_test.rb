...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { documento: @pessoa.documento, nome: @pessoa.nome, tipo_pessoa: @pessoa.tipo_pessoa } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { documento: @pessoa.documento, nome: @pessoa.nome, tipo_pessoa: @pessoa.tipo_pessoa } }
